...
<body>
	<%
		List<String> inMessages = (List) request.getAttribute("outMessages");
		if (inMessages == null) {
			response.sendRedirect("success.jsp");
		} else {

			out.println("<form action=\"outMessageShow.user\" method=\"post\">");
			out.println("Выберите сообщение: <br><p><select size=\"1\" name=\"outMessages\">");
